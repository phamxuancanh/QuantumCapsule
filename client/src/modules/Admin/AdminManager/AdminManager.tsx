            ...
            <PanelGroup direction="horizontal">
                                                            ...
                                                            label={
                                                                <Box display={"flex"} justifyContent={"space-between"}>
                                                                    <Typography fontSize={20}>
                                                                        ...
                                                                        {/* <Typography color={"blue"} component={'span'} fontSize={20}>
                ...
                <PanelResizeHandle>
                    <Box sx={{
                        ...
                        alignItems: 'center',
                        height: '100%', // Tăng chiều cao để dễ nhìn
                        // backgroundColor: '#d0d0d0', // Màu nền rõ ràng hơn
                        cursor: 'row-resize', // Con trỏ phù hợp cho việc kéo dọc
                    }}>
                    ...
                    <Box >
                        {
                            actQuanLy.open && actQuanLy.payload?.type === 'exam' &&(
                                <Box>
                                    <Typography fontSize={25} fontWeight={"bold"} color={"#4ADE80"}>Danh sách câu hỏi: {actQuanLy.payload?.data?.name}</Typography>
                                    <SimpleTable 
                                        ...
                                        columns={[
                                            ...
                                            { field: 'questionType', headerName: 'Loại câu hỏi', minWidth: 200, 
                                                editable: true,
                                            ...
                                            { field: 'content', headerName: 'Nội dung', minWidth: 200, editable: true },
                                            { field: 'contentImg', headerName: 'Ảnh', minWidth: 200, editable: true },
                                            { field: 'A', headerName: 'A', minWidth: 130, editable: true },
                                            { field: 'B', headerName: 'B', minWidth: 130, editable: true },
                                            { field: 'C', headerName: 'C', minWidth: 130, editable: true },
                                            { field: 'D', headerName: 'D', minWidth: 130, editable: true },
                                            { field: 'E', headerName: 'E', minWidth: 130, editable: true },
                                            { field: 'correctAnswer', headerName: 'Đáp án đúng', minWidth: 130, editable: true },
                                            { field: 'explainAnswer', headerName: 'Giải thích đáp án', minWidth: 130, editable: true },
                                        ] as GridColDef[]}
                                        onRowClick={(row) => {
                        ...
                        }
                        {
                            actQuanLy.open && (
                                ...
                                <Box>
                                    <Typography fontSize={25} fontWeight={"bold"} color={"#4ADE80"}>Ngân hàng câu hỏi {actQuanLy.payload?.data?.name}</Typography>
                                    <SimpleTable 
                                        initData={listQuestion ? listQuestion : [] as IQuestion[]}
                                        toolbarComponent={<Box display={"flex"} gap={1}>
                                            <ExcelReaderBtn variant='outlined' sheetIndex={0} name='Thêm từ excel' onUpload={async (data)=>{
                        ...
                        }
                        {
                            actQuanLy.open && (
                                ...
                                <Box>
                                    <Typography fontSize={25} fontWeight={"bold"} color={"#4ADE80"}>Danh sách bài giảng {actQuanLy.payload?.data?.name}</Typography>
                                    <SimpleTable 
                ...
                <Box>
                    <SimpleTable
                        ...
                        columns={[
                            ...
                            { field: 'content', headerName: 'Nội dung', minWidth: 200},
                            { field: 'contentImg', headerName: 'Ảnh', minWidth: 200},
                            { field: 'A', headerName: 'A', minWidth: 130 },
                            { field: 'B', headerName: 'B', minWidth: 130},
                            { field: 'C', headerName: 'C', minWidth: 130 },
                            { field: 'D', headerName: 'D', minWidth: 130 },
                            { field: 'E', headerName: 'E', minWidth: 130 },
                            { field: 'correctAnswer', headerName: 'Đáp án đúng', minWidth: 130},
                            { field: 'explainAnswer', headerName: 'Giải thích đáp án', minWidth: 130},
                        ] as GridColDef[]}
                    />
                </Box>
            </ComfirmModal>

...
const SignUp = () => {
    ...
    async function handleRegister(e: { preventDefault: () => void; }) {
        ...
        const messUsername = t('signUp.username_required');
        const messEmail = t('signUp.email_required');
        const messPassword = t('signUp.password_required');
        const messConfirm = t('signUp.passwordConfirm_required');
        const messTermCheckBox = t('signUp.term_required');
    
        const schema = yup.object({
            firstName: yup
                .string()
                .matches(/^[A-Za-z]+$/, t('signUp.first_name_invalid'))
                .required(messFirstName),
            lastName: yup
                .string()
                .matches(/^[A-Za-z]+$/, t('signUp.last_name_invalid'))
            ...
            username: yup
                .string()
                .matches(/^[a-zA-Z0-9]*$/, t('signUp.username_invalid'))
